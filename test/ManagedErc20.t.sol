...
contract ManagedErc20Test is Test {
    ...
    address public minter = address(1234);
    address public burner = address(1235);
    address public deployer = address(1236);
    address public investor = address(1237);
    ...
    function test01_CanDeployToken() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(bytes4(keccak256("InvalidTokenDecimals()"))));
        ...
        vm.expectRevert(abi.encodeWithSelector(bytes4(keccak256("InvalidDeployer()"))));
        token.configure(minter, burner);

        // Watch it fail: provide an invalid minter address
        vm.startPrank(deployer);

        vm.expectRevert(abi.encodeWithSelector(bytes4(keccak256("InvalidMinter()"))));
        ...
        vm.expectRevert(abi.encodeWithSelector(bytes4(keccak256("InvalidBurner()"))));
    ...
    function test02_CanMintAndBurnToken() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(bytes4(keccak256("TokenNotConfigured()"))));
        ...
        vm.prank(minter);
        vm.expectRevert(abi.encodeWithSelector(bytes4(keccak256("InvalidTargetAddress()"))));
    ...
    function test03_CanTransferToken() public {
        ...
        vm.prank(minter);
        token.transferFrom(investor, minter, 200);
